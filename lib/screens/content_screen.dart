          ...
          child: Row(
            children: [
              Container(
                ...
                child: Icon(Icons.play_arrow, color: Colors.white, size: 24 * _scale),
              ),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(_t('点击播放音频', 'Tap to play audio'), style: TextStyle(fontSize: 11 * _scale, color: AppTheme.textLight)),
                  ],
                ),
              ),
